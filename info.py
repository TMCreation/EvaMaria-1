...
API_ID = int(environ.get('API_ID', '6764849'))
API_HASH = environ.get('API_HASH', '682f2b9a44e0aab50c6e559963e19ff0')
BOT_TOKEN = environ.get('BOT_TOKEN', '1973939003:AAG084aGDERxGL7tGwf_vG5rZPyN-RjsMd8')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b><code>{file_name}</code> » {file_size} › [《《 © 🄲🄸🄽🄴🄷🅄🄱 coммυɴιтy 》》](https://t.me/cinehub_family)</b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "<b>{file_name} » {file_size} › [《《 © 🄲🄸🄽🄴🄷🅄🄱 coммυɴιтy 》》](https://t.me/cinehub_family)</b>")
